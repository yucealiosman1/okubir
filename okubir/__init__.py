...
admin.add_view(SummaryView(Summary, db.session))
admin.add_view(CommonView(InterestArea, db.session))
admin.add_view(CommonView(BookCategory, db.session))
admin.add_view(CommonView(UserBookLog, db.session))
